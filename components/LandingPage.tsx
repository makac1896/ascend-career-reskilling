      ...
      >
        <div className='max-w-7xl mx-auto px-6 flex justify-between items-center'>
          ...
          <div className='hidden md:flex items-center gap-8'>
            <a
              href='#mission'
              className={`text-sm font-medium transition-colors ${scrolled ? "text-slate-600 hover:text-blue-600" : "text-white/80 hover:text-white"}`}
            >
              Mission
            </a>
            <a
      ...
      <header className='relative h-screen flex items-center justify-center overflow-hidden'>
        ...
        <div className='relative z-10 max-w-5xl mx-auto px-6 text-center text-white'>
          ...
          <h1 className='text-5xl md:text-7xl font-extrabold tracking-tight mb-6 leading-tight animate-in fade-in slide-in-from-bottom-6 duration-1000 delay-100'>
            Becoming <span className='text-blue-400'>Future-Ready.</span>
            <br />
          ...
          <p className='text-xl md:text-2xl text-gray-200 max-w-3xl mx-auto mb-10 leading-relaxed font-light animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-200'>
            Helping students move from stress to success. The platform for the
            next generation of career centers.
          </p>
        ...
        <div className='max-w-7xl mx-auto px-6'>
          <div className='text-center mb-20 max-w-3xl mx-auto'>
            ...
            <p className='text-lg text-slate-600 leading-relaxed'>
              Students are facing a perfect storm. Data from major institutions
              reveals the biggest challenges in higher education today.
            </p>
          </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            ...
            <div className='bg-white p-8 rounded-3xl shadow-sm border border-slate-200 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group'>
              ...
              <p className='text-slate-600 leading-relaxed mb-4'>
                The pressure to have a perfect resume and fear of missing out
                has led to burnout. 72% of students report feeling frequently
                overwhelmed.
              </p>
            ...
            <div className='bg-white p-8 rounded-3xl shadow-sm border border-slate-200 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group'>
              ...
              <p className='text-slate-600 leading-relaxed mb-4'>
                Many students feel lost. The pressure to perform without knowing
                "Why" creates a crisis of engagement.
              </p>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-16 items-center'>
            <div>
              ...
              <p className='text-lg text-slate-600 mb-8 leading-relaxed'>
                Waypoint isn't just a job board. It helps students move from
                anxiety to action through four simple steps.
              </p>

              <div className='space-y-6'>
                {[
                  {
                    title: "Discover Superpowers",
                    desc: "Identify core strengths and values to build a sense of purpose.",
                    icon: <Users className='w-5 h-5 text-blue-600' />,
                  },
                  {
                    title: "Future-Ready Skills",
                    desc: "Focus on skills that matter: Empathy, Ethics, and Strategic Thinking.",
                    icon: <Shield className='w-5 h-5 text-blue-600' />,
                  },
                  {
                    title: "Build Resilience",
                    desc: "Develop personal growth plans that balance tech skills with human skills.",
                    icon: <TrendingUp className='w-5 h-5 text-blue-600' />,
                  },
                  {
                    title: "Continuous Growth",
                    desc: "Turn uncertainty into opportunity through feedback and reflection.",
      ...
      <section className='relative py-32 bg-slate-900 text-white overflow-hidden'>
        ...
        <div className='relative z-10 max-w-4xl mx-auto px-6 text-center'>
          <h2 className='text-4xl md:text-6xl font-bold mb-8'>
            The crisis of today is your opportunity.
          </h2>
