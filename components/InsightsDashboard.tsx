  ...
  return (
    <div className="flex flex-col gap-8 w-full max-w-[1600px] mx-auto pb-10 animate-in fade-in duration-500">
        ...
        <div className="flex items-center justify-between">
             <div>
                <h2 className="text-3xl font-bold text-ascend-text tracking-tight mb-2">Insights Engine</h2>
                <p className="text-ascend-subtext text-sm font-medium">Global radar scanning for external skill signals and market trends.</p>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 h-auto lg:h-[600px]">
            ...
            <div className="lg:col-span-5 panel-base p-8 h-[600px] flex flex-col">
                 <div className="flex items-center gap-3 mb-2">
                    ...
                    <div>
                        <h3 className="text-xl font-bold text-ascend-text">Market Signals</h3>
                        <p className="text-xs text-ascend-subtext">Live job requirements & industry reports.</p>
                    </div>
                 </div>
